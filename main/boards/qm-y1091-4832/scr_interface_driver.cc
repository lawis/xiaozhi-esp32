...
{
    interface_i2s_handle_t *interface_i2s = (interface_i2s_handle_t*)__containerof((  scr_interface_driver_t*)handle, interface_i2s_handle_t, interface_drv);
...
static esp_err_t spi_lcd_driver_init(const scr_interface_spi_config_t *cfg, interface_spi_handle_t *out_interface_spi)
{
    ...
    gpio_pad_select_gpio((gpio_num_t)cfg->pin_num_dc);
    gpio_set_direction((gpio_num_t)cfg->pin_num_dc, GPIO_MODE_OUTPUT);
    out_interface_spi->pin_num_dc = cfg->pin_num_dc;
    out_interface_spi->swap_data = cfg->swap_data;

    spi_device_config_t devcfg = {
        .cs_io_num = (gpio_num_t)cfg->pin_num_cs,        //CS pin
        .mode = 0,                           //SPI mode 0
...
{
    interface_spi_handle_t *interface_spi = (interface_spi_handle_t *)__containerof((scr_interface_driver_t*)handle, interface_spi_handle_t, interface_drv);
    esp_err_t ret;
    gpio_set_level((gpio_num_t)interface_spi->pin_num_dc, LCD_CMD_LEV);
    ret = _lcd_spi_rw(interface_spi->spi_wr_dev, cmd, NULL, length);
    gpio_set_level((gpio_num_t)interface_spi->pin_num_dc, LCD_DATA_LEV);
...
esp_err_t scr_interface_create(scr_interface_type_t type, void *config, scr_interface_driver_t **out_driver)
{
    ...
    case SCREEN_IFACE_8080: {
        interface_i2s_handle_t *interface_i2s = (interface_i2s_handle_t *)heap_caps_malloc(sizeof(interface_i2s_handle_t), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
    ...
    case SCREEN_IFACE_SPI: {
        interface_spi_handle_t *interface_spi = (interface_spi_handle_t *)heap_caps_malloc(sizeof(interface_spi_handle_t), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
    ...
    case SCREEN_IFACE_I2C: {
        // interface_i2c_handle_t *interface_i2c = (interface_i2c_handle_t *)heap_caps_malloc(sizeof(interface_i2c_handle_t), MALLOC_CAP_INTERNAL | MALLOC_CAP_8BIT);
...
esp_err_t scr_interface_delete(const scr_interface_driver_t *driver)
{
    ...
    case SCREEN_IFACE_I2C: {
        // interface_i2c_handle_t *interface_i2c = (interface_i2c_handle_t*)__containerof(driver, interface_i2c_handle_t, interface_drv);
